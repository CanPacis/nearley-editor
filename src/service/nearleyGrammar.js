...
var grammar = {
  ...
  ParserRules: [
    {
      name: "final$ebnf$1",
      symbols: [lexer.has("ws") ? { type: "ws" } : rules.ws],
      postprocess: id,
    },
    {
      name: "final$ebnf$1",
    ...
    },
    {
      ...
      symbols: [
        "word",
        "_",
        lexer.has("arrow") ? { type: "arrow" } : rules.arrow,
        "_",
        "expression+",
      ],
      postprocess: function (d) {
    ...
    },
    {
      ...
      postprocess: function (d) {
        return { macro: d[0], args: d[3], exprs: d[9] };
      },
    },
    {
      name: "prod",
      symbols: [{ literal: "@" }, "_", "js"],
      postprocess: function (d) {
        return { body: d[2] };
      },
    },
    ...
    {
      name: "prod",
      symbols: [{ literal: "@include" }, "_", "string"],
      postprocess: function (d) {
    ...
    {
      name: "prod",
      symbols: [{ literal: "@builtin" }, "_", "string"],
      postprocess: function (d) {
    ...
    {
      name: "wordlist",
      symbols: ["wordlist", "_", { literal: "," }, "_", "word"],
      postprocess: function (d) {
        return d[0].concat([d[4]]);
      },
    },
    ...
    {
      name: "word",
      symbols: [lexer.has("word") ? { type: "word" } : rules.word],
      postprocess: getValue,
    },
    {
      name: "string",
      symbols: [lexer.has("string") ? { type: "string" } : rules.string],
      postprocess: (d) => ({ literal: d[0].value }),
    },
    {
      name: "string",
      symbols: [lexer.has("btstring") ? { type: "btstring" } : rules.btstring],
      postprocess: (d) => ({ literal: d[0].value }),
    },
    {
      name: "charclass",
      symbols: [
        lexer.has("charclass") ? { type: "charclass" } : rules.charclass,
      ],
      postprocess: getValue,
    },
    {
      name: "js",
      symbols: [lexer.has("js") ? { type: "js" } : rules.js],
      postprocess: getValue,
    },
    ...
    { name: "ws", symbols: [lexer.has("ws") ? { type: "ws" } : rules.ws] },
    {
      name: "ws$ebnf$1",
      symbols: [lexer.has("ws") ? { type: "ws" } : rules.ws],
      postprocess: id,
    ...
    },
    {
      ...
      symbols: [
        "ws$ebnf$1",
        lexer.has("comment") ? { type: "comment" } : rules.comment,
        "_",
      ],
    },
  ],
